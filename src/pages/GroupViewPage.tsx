...
const GroupViewPage: React.FC = () => {
  ...
  const connectWebSocket = useCallback((taskId: string) => {
    const connectWebSocket = useCallback((targetTaskId: string) => {
      console.log('🔌 Attempting to connect WebSocket for task:', targetTaskId);
      ...
      const wsUrl = `${BACKEND_WS_URL}/api/v1/ws/tracking/${targetTaskId}?tab_id=${tabIdRef.current}`;
      console.log('🔌 Connecting to WebSocket URL:', wsUrl);
      console.log('🔌 Using task ID:', targetTaskId);
